...
const Dashboard = () => {
  ...
  if (isTenant) {
    ...
    statCards = [
      ...
      { label: 'Aset Disewa (Hari Ini)', value: stats.rentedAssets, icon: Clock, color: 'text-blue-600', bg: 'bg-blue-50' },
      { label: 'Aset Tersedia (Nganggur)', value: stats.availableAssets, icon: CheckCircle, color: 'text-emerald-600', bg: 'bg-emerald-50' },
